# Had been using this script to run tests. Script saved data to a CSV File (Comma-Separated -Values text file)  which could be opened by Excel. Problem was script saved the data 
